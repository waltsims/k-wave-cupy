function sensor_data = kspaceFirstOrder3D(kgrid, medium, source, sensor, varargin)
%KSPACEFIRSTORDER3D Shim that redirects to Python backend.
%
% This shim allows existing k-Wave tests to transparently use the
% Python/CuPy backend by replacing kspaceFirstOrder3D calls.
%
% USAGE:
